...
def load_csv_data():
    ...
    pd.read_csv("data/product entries.csv").to_sql("products", conn, if_exists="replace", index=False)
    pd.read_csv("data/customers.csv").to_sql("customers", conn, if_exists="replace", index=False)
    pd.read_csv("data/sales entries.csv").to_sql("sales", conn, if_exists="replace", index=False)
    pd.read_csv("data/workers entries.csv").to_sql("workers", conn, if_exists="replace", index=False)
    pd.read_csv("data/inventory entries.csv").to_sql("inventory", conn, if_exists="replace", index=False)
